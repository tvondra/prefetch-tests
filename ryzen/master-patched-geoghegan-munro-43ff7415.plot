...
set output 'ryzen/master-patched-geoghegan-munro-43ff7415.png'
...
plot 'ryzen/master-patched-geoghegan-munro-43ff7415.data' using 1:2:3 w points pt 7 ps 0.75 palette, \
