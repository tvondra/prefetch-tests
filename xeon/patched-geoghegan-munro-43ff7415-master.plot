...
set output 'xeon/patched-geoghegan-munro-43ff7415-master.png'
...
plot 'xeon/patched-geoghegan-munro-43ff7415-master.data' using 1:2:3 w points pt 7 ps 0.75 palette, \
