...
PATH_OLD=$PATH
DATADIR=/mnt/raid-nvme/data-prefetch
						...
						for order in asc desc; do
							...
							for run in $(seq 1 3); do
								...
								while /bin/true; do
									...
									for b in master simple complex; do

										qid=$((qid+1))

										PATH=/home/tomas/builds/$b/bin:$PATH_OLD
										...
										echo "=========== DATASET: $did QUERY: $qid fillfactor: $fillfactor rows: $rows fuzz: $fuzz fuzz2: $fuzz2 step: $step iomethod: $iomethod ioworkers: $ioworkers eic: $eic iorder: $iorder order: $order build: $b values: $values start: $start end: $end ===========" >> $TS/explains.log
