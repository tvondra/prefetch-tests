...
set output 'ryzen-nvme/patched-munro-patched-old-munro.png'
...
plot 'ryzen-nvme/patched-munro-patched-old-munro.data' using 1:2:3 w points pt 7 ps 0.75 palette, \
